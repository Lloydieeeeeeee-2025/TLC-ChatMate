                                ...
                                <div className="border border-gray-200 w-full p-4 rounded-md  hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div className="w-full flex-1 overflow-y-auto max-h-[350px] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">Form 138 (Report Card)</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">Certificate of Good Moral Character</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">2 pieces of 2x2 recent ID picture</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">2 pieces of Long size White Folders</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">PSA Birth Certificate (Original Copy)</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">Medical Certificate</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">Police Clearance</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">3 pcs. long size mailing envelop</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="">Mailing Stamps (worth Php 80.00)</span>
                                ...
                                <div className="border border-gray-200 w-full p-4 rounded-md  hover:shadow-md transition-shadow duration-300 mt-4 sm:mt-0">
                                    ...
                                    <div className="w-full flex-1 overflow-y-auto max-h-[350px] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="text-gray-700">Go to HED Registrar Office</span>
                                            ...
                                            <div className="flex w-full items-center justify-between border border-gray-200 p-3 rounded hover:bg-gray-50 transition">
                                                <span className="text-gray-700">Pay Tuition</span>
